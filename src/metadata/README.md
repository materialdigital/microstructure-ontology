 ...
 * [microstructure.yml](microstructure.yml)
     * Determines how your purl.obolibrary.org/obo/microstructure/ redirects will be handled
     ...
     * Paste in the contents of [microstructure.yml](microstructure.yml)
 ...
 * [microstructure.md](microstructure.md)
     ...
     * Paste in the contents of [microstructure.md](microstructure.md)
     * Click "Commit new file"
     * IMPORTANT: remember to make a pull request
     * An OBO admin will merge your Pull Request *providing it meets the requirements of the OBO library*
